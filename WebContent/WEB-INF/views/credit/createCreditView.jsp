            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Crèdit <small>Registrar crèdit</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
    			...
    			<div class="row">
                    <div class="col-lg-12">
		    			...
		    			<form class="form-horizontal" method="POST" action="DoCreateCredit">
		    				...
		    				<div class="form-group">
                                <label class="col-xs-3  control-label">Presupost</label>
                                <div class="col-xs-3">
                                	<input class="form-control" name="presupost" placeholder="0000,00"> 
                                </div>
