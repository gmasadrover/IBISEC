 	...
 	<div id="wrapper">
    	...
    	<div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Escritura <small>Modificar</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                ...
                <!-- /.row -->
               	<form class="form-horizontal" method="POST" enctype="multipart/form-data" action="doEditEscritura">   
               		<input type="hidden" name="refBastanteo" value="${refBastanteo}"/> 
               		<input type="hidden" name="ref" value="${ref}"/>             		
               		<h2 class="margin_bottom30">Modificar escritura</h2>                		              		
		    		<div class="row">			    				    				    		
	                    <div class="col-md-6">	
                	...
                	<div class="row">
                		<div class="form-group">
					        <div class="col-xs-offset-9 col-xs-9">
					            <input type="submit" class="btn btn-primary" value="Modificar escritura">							            
					        </div>
					    </div> 
                	</div>
                </form>
