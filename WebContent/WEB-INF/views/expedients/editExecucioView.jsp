            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Execució
                            </li>
                            <li class="active">
                ...
                <c:if test="${not empty expedient}">
                	<form class="form-horizontal" method="POST" enctype="multipart/form-data" action="doEditExecucio">                		
			    		...
			    		<div class="row">			    				    				    		
		                    ...
		                    <div class="col-md-6">  
		                    	<div class="form-group">
	                                <label class="col-xs-3 control-label">Data publicació perfil contratant</label>
	                                <div class="input-group date col-xs-6 datepicker">
									  	<input type="text" class="form-control" name="dataPerfilContratant" value="${expedient.getDataPublicacioPerfilContratantString()}"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
									</div>
	                            </div>	
	                            <div class="form-group">
