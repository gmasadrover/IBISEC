                	...
                	<form class="form-horizontal" method="POST" enctype="multipart/form-data" action="doEditInforme">   
				       		...
				       		<div class="visibleObres visibleObres">					                             	
					            ...
					            <div class="col-md-3 visibleTipusLlicencia visibleTipusLlicencia">
					           	...
					           	<div class="col-md-3">
					      	 		...
					      	 		<input type="hidden" id="formContractePrev" value="${informePrevi.propostaInformeSeleccionada.contracte}" >
						...
						<div class="form-group">
				    		<div class="col-md-4">	
				      			...
				      			<input type="hidden" id="partidaPrev" value="${informePrevi.codiPartida}" >							            	 										            	 	
