...
<body>	
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Penalitzacions <small>Expedients</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Penalitzacions
                            </li>
                            <li class="active">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive">                        
                            <table class="table table-striped table-bordered filerTable">
                                ...
                                <tbody>
                                	<c:forEach items="${penalitzacionsList}" var="informe" >
    ...
    <script src="js/expedient/llistatPenalitzacions.js?<%=application.getInitParameter("datakey")%>"></script>
    <!-- /#wrapper -->
</body>
</html>