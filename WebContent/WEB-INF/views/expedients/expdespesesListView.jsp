                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Expedients <small>Despeses d'Explotació</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Despeses d'Explotació
                            </li>
                            <li class="active">
							          	...
							          	<tr class=${informe.expcontratacio.anulat ? "danger" : informe.llistaModificacions.size() > 0 ? "warning" : "success"}>							          	
							           		<td>
							           			<c:choose>
							           				...
							           				<c:otherwise>
							           					<a href="actuacionsDetalls?ref=${informe.actuacio.referencia}&exp=${informe.idInf}" class="loadingButton"  data-msg="obrint expedient...">${informe.idInf}</a>
							           				</c:otherwise>
							           			 </c:choose>
							           		</td>
