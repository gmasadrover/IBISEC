...
<div class="row">
	<div class="col-md-12">
		<c:choose>
			<c:when test="${informePrevi.llicencia.codi==null}">
							...
							<div class="row">
					   			<c:if test="true">
									<div class="col-md-offset-9 col-md-2 margin_top30">
										<a href="crearLlicencia?idInforme=${informePrevi.idInf}" class="btn btn-primary" role="button">Crear</a>
									</div>
								</c:if>
					 		</div>       
						</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="row">
					   			<c:if test="true">
									<div class="col-md-offset-9 col-md-2 margin_top30">
										<a href="editLlicencia?codi=${informePrevi.llicencia.codi}&exp=${informePrevi.idInf}&from=expedient" class="btn btn-primary" role="button">Editar</a>
									</div>
								</c:if>
					 		</div>       
						</div>
