    	...
    	<jsp:include page="../_menu.jsp"></jsp:include>
       	<div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Factures no conformades pendents (+15 dies)<small></small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i>  Factures no conformades pendents (+15 dies)
                            </li>
                            <li class="active">
				...
				<div class="row">
                    <div class="col-md-12">
                        <h2>Factures no conformades pendents (+15 dies)</h2>
