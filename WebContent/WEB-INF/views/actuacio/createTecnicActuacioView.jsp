...
<body>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                           Actuació<small> Assignació tècnic</small>
                        </h1>
                        <ol class="breadcrumb">
					       	<li class="active">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Assignació tècnic
                            </li>                       
                        </ol>
                    </div>
                </div>
		    			...
		    			<form class="form-horizontal" method="POST" enctype="multipart/form-data" action="DoEditPersonalExpedient">		    				
		    				<div id="seleccionarInforme">                            		
	                            <div class="form-group">
	                                ...
	                                <div class="col-xs-3">
		                                <select class="form-control selectpicker centresList" name="idCentre" data-live-search="true" data-size="5" id="centresList"></select>
		                             </div>
	                            </div> 
							...
							<div class="form-group">
				                ...
				                <div class="col-xs-3">	
					                <select class="form-control selectpicker" name="llistaFuncions" id="llistaFuncions">
					                	...
					                	<option value="Tècnic d'instal·lacions">Tècnic d'instal·lacions</option>			                					                                	
					                </select>
					        	</div>	
							</div>
                            <br>
    ...
    <script src="js/actuacio/assignacioTecnic.js?<%=application.getInitParameter("datakey")%>"></script>
</body>
</html>