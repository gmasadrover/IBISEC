                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Actuacions <small>Modificar actuació</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                    ...
                    <div class="col-md-12">                    	                    	
		    			<form class="form-horizontal" method="POST" action="DoModificarActuacio">
		    				...
		    				<div class="form-group">
                                ...
                                <div class="col-xs-3">
                                	<input class="form-control" value="${actuacio.referencia}" disabled>
                                </div>
                            </div>  
		    				<div class="form-group">
                                <label class="col-xs-3 control-label">Descripció</label>
                                <div class="col-xs-3">
                                	<textarea class="form-control" name="descripcio" placeholder="descripció" rows="3">${actuacio.descripcio}</textarea>
                                </div>
                            </div>		
                            <div class="form-group">
                                <label class="col-xs-3 control-label">Observacions</label>
                                <div class="col-xs-3">
                                	<textarea class="form-control" name="observacio" placeholder="observacions" rows="3">${actuacio.notes}</textarea>
                                </div>
                            </div>		
                            <br>
						    <div class="form-group">
