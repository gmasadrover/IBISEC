	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (reserva.getAutoritzacio() == null) {
			if (aprovar != null) {
				...
				TascaCore.nouHistoric(conn, idTasca, "Sol·licitud aprovada", usuariLogetjat.getIdUsuari(), ipRemote, "automatic");	
			...
			if (aprovar != null) {
				...
				TascaCore.nouHistoric(conn, idTasca, "Vitiplau a la sol·licitud", usuariLogetjat.getIdUsuari(), ipRemote, "automatic");				
			} else {
				CalendarCore.rebutjarVistiplauVacances(conn, idSolicitud);
				TascaCore.nouHistoric(conn, idTasca, "<span class='missatgeAutomatic'>Vitiplau a la sol·licitud rebutjada</span><br> Motiu: " + comentari, usuariLogetjat.getIdUsuari(), ipRemote, "manual");				
			}
			TascaCore.reasignar(conn, reserva.getIdUsuari(), idTasca, tasca.getTipus(), tasca.getDescripcio());
		}
