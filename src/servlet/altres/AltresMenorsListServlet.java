...
import core.AltresCore;
import core.ControlPageCore;
import core.UsuariCore;
import utils.MyUtils;

/**
 * Servlet implementation class AltresMenorsListServlet
 */
@WebServlet("/altresMenors")
public class AltresMenorsListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AltresMenorsListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (usuari == null) {
			...
			try {
				...
				list = AltresCore.AltresMenors(conn, idCentre, dataInici, dataFi);				
			...
			request.setAttribute("menu", ControlPageCore.renderMenu(conn, usuari,"Altres"));
			// Forward to /WEB-INF/views/homeView.jsp
			// (Users can not access directly into JSP pages placed in WEB-INF)
			RequestDispatcher dispatcher = this.getServletContext()
					.getRequestDispatcher("/WEB-INF/views/altres/altresMenorsList.jsp");
