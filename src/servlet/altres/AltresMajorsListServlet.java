...
/**
 * Servlet implementation class AltresMajorsListServlet
 */
@WebServlet("/altresMajors")
public class AltresMajorsListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AltresMajorsListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (usuari == null) {
			...
			try {
				...
				list = AltresCore.AltresMajor(conn, idCentre, dataInici, dataFi);
			...
			RequestDispatcher dispatcher = this.getServletContext()
					.getRequestDispatcher("/WEB-INF/views/altres/altresMajorsList.jsp");
