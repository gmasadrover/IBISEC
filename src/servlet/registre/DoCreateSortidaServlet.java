	   	...
	   	if (errorString == null) {
	   		try {
	   			...
	   			if(tipus.equals("Procediment judicial")) {	   				
	   				...
	   				TascaCore.novaTasca(conn, "judicial", usuariTasca, idUsuari, "-1", "-1", "S'ha registrat un document de sortida al procediment " + numAutos, "Nova documentaci� procediment", refPro, null);
