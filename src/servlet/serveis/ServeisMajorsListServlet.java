...
/**
 * Servlet implementation class ServeisMajorsListServlet
 */
@WebServlet("/serveisMajors")
public class ServeisMajorsListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServeisMajorsListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (usuari == null) {
			...
			try {
				...
				list = ServeisCore.ServeisMajor(conn, idCentre, dataInici, dataFi);
			...
			RequestDispatcher dispatcher = this.getServletContext()
					.getRequestDispatcher("/WEB-INF/views/serveis/serveisMajorsList.jsp");
