...
import core.ServeisCore;
import core.UsuariCore;
import utils.MyUtils;

/**
 * Servlet implementation class ServeisMenorsListServlet
 */
@WebServlet("/serveisMenors")
public class ServeisMenorsListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServeisMenorsListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (usuari == null) {
			...
			try {
				...
				list = ServeisCore.ServeisMenors(conn, idCentre, dataInici, dataFi);				
			...
			request.setAttribute("menu", ControlPageCore.renderMenu(conn, usuari,"Serveis"));
			// Forward to /WEB-INF/views/homeView.jsp
			// (Users can not access directly into JSP pages placed in WEB-INF)
			RequestDispatcher dispatcher = this.getServletContext()
					.getRequestDispatcher("/WEB-INF/views/serveis/serveisMenorsList.jsp");
