...
/**
 * Servlet implementation class SubministramentMajorsListServlet
 */
@WebServlet("/subministramentMajors")
public class SubministramentMajorsListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SubministramentMajorsListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (usuari == null) {
			...
			try {
				...
				list = SubministramentCore.SubministramentMajor(conn, idCentre, dataInici, dataFi);
			...
			RequestDispatcher dispatcher = this.getServletContext()
					.getRequestDispatcher("/WEB-INF/views/subministrament/subministramentMajorsList.jsp");
