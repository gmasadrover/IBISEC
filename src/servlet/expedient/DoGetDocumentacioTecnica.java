...
public class DoGetDocumentacioTecnica extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		adjunts = InformeCore.getControlQualitat(conn, idIncidencia, idActuacio, idInf);
		llistatObj = gson.toJsonTree(adjunts);
		myObj.add("documentControlQualitat", llistatObj);		
		...
		adjunts = InformeCore.getCertificatsBonaExecucio(conn, idIncidencia, idActuacio, idInf);
		llistatObj = gson.toJsonTree(adjunts);
		myObj.add("documentCertificatsBonaExecucio", llistatObj);
