...
public class DoCreateTascaAutoritzacioDespesa extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String comentari = "Sol·licitud aprovació despesa: " + idInforme;			
			TascaCore.novaTasca(conn, "autoritzacioDespesa", idUsuari, Usuari.getIdUsuari(), informe.getActuacio().getReferencia(), informe.getIdInf(), comentari, "Sol·licitud proposta despesa", idInforme, null);
