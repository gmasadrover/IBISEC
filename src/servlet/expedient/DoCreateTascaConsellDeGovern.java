...
public class DoCreateTascaConsellDeGovern extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String comentari = "Sol·licitud aprovació consell de govern expedient: " + informe.getExpcontratacio();			
			TascaCore.novaTasca(conn, "consellDeGovern", idUsuari, Usuari.getIdUsuari(), informe.getActuacio().getReferencia(), informe.getIdInf(), comentari, "Sol·licitud aprovació consell de govern", idInforme, null);
