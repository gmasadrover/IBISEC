...
@WebServlet(urlPatterns = { "/doEditExpedient" })
public class DoEditExpedientServlet extends HttpServlet {
   private static final long serialVersionUID = 1L;
 
   public DoEditExpedientServlet() {
       super();
   }
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
       	...
       	try {
			...
			expedient.setDescripcio(multipartParams.getParametres().get("descripcio"));
		...
		// Redirect to the product listing page.            
           ...
           response.sendRedirect(request.getContextPath() + "/editExpedient?ref=" + expedient.getExpContratacio());
		}
   	}
