...
public class DoEditInstalacionsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			Fitxers.guardarFitxer(multipartParams.getFitxersByName().get("documentsIntalacioBaixaTensio"), idIncidencia, idActuacio, "", "", "", idInforme, "Instalacio baixa tensio");
			Fitxers.guardarFitxer(multipartParams.getFitxersByName().get("documentsIntalacioContraincendis"), idIncidencia, idActuacio, "", "", "", idInforme, "Instalacio contraincencis");
			Fitxers.guardarFitxer(multipartParams.getFitxersByName().get("documentsCertificatEficienciaEnergetica"), idIncidencia, idActuacio, "", "", "", idInforme, "Certificat eficiència energètica");
			Fitxers.guardarFitxer(multipartParams.getFitxersByName().get("documentsIntalacioTermica"), idIncidencia, idActuacio, "", "", "", idInforme, "Instalacio termica");
			Fitxers.guardarFitxer(multipartParams.getFitxersByName().get("documentsIntalacioAscensor"), idIncidencia, idActuacio, "", "", "", idInforme, "Instalacio ascensor");
			Fitxers.guardarFitxer(multipartParams.getFitxersByName().get("documentsIntalacioAlarma"), idIncidencia, idActuacio, "", "", "", idInforme, "Instalacio alarma");
			Fitxers.guardarFitxer(multipartParams.getFitxersByName().get("documentsIntalacioSubministreAigua"), idIncidencia, idActuacio, "", "", "", idInforme, "Subministre aigua");
			Fitxers.guardarFitxer(multipartParams.getFitxersByName().get("documentsPlaAutoproteccio"), idIncidencia, idActuacio, "", "", "", idInforme, "Pla autoproteccio");
			Fitxers.guardarFitxer(multipartParams.getFitxersByName().get("documentsCedulaDeHabitabilitat"), idIncidencia, idActuacio, "", "", "", idInforme, "Cedula habitabilitat");
			Fitxers.guardarFitxer(multipartParams.getFitxersByName().get("documentsInstalacioPetrolifera"), idIncidencia, idActuacio, "", "", "", idInforme, "Instalació petrolifers");
